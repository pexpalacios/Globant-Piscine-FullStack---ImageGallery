...
export default function HomePage() {
	...
	{/* Top Bar */}
		...
		className="basis-1/6 p-3 rounded-full hover:bg-btnhover-light focus:outline-2 focus:outline-offset-2 bg-btnbg-light text-text-light dark:bg-btnbg-dark dark:text-text-dark dark:hover:bg-btnhover-dark">Log In</button>
